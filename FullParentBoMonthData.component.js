...
import ParentBoMonthlyData from "./ParentBoMonthlyData.component";
import {
    Container,
    Card,
    Row,
...
export default class FullParentBoMonthData extends Component {
    constructor(props) {
        super(props);
        this.state = {
            totalAmount: 0,
                          ...
                          
                          {
                                     keyData.components.map((data, componentindex) => {
                                       ...
                                       if(data.month===keyData.month){
                                           return (
                                             <ParentBoMonthlyData  {...this.props} data={data} changeTotalAmount={this.setAmountValue} selectedSeason={this.props.selectedSeason}selectedYear={this.props.selectedYear}selectedStatus={this.props.selectedStatus}/>
